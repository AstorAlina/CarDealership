...
public class VehicleRepository {
    ...
    public List<Vehicle> getAllVehicles(int id) {
        String query = "{CALL AllVehiclesFromDealershipId(?)}";
    ...
    public void addVehicles(Vehicle vehicle) {
        ...
        try (Connection conn = basicDataSource.getConnection();
            ...
            cs.setString(3, vehicle.getMake());
            cs.setString(4, vehicle.getModel());
    ...
    public void addSalesContract(String contractDate, SalesContract salesContract) {
        ...
        try (Connection conn = basicDataSource.getConnection();
            ...
            cs.setBoolean(2, salesContract.isFinanced());
            cs.setDouble(3, salesContract.getSalesTax());
    ...
    public void addLeaseContract(String contractDate, LeaseContract leaseContract) {
        ...
        try (Connection conn = basicDataSource.getConnection();
            ...
            cs.setDouble(5, leaseContract.getEndingValue());
    ...
    public List<Vehicle> isVehicleAvailable(int vin) {
        ...
        try (Connection conn = basicDataSource.getConnection();
            ...
            while (resultSet.next()) {
                ...
                Vehicle vehicle = new Vehicle(vin1, year, vehicleMake, vehicleModel, vehicleType, color, odometer, price, sold);
